...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 31 juil. 2024 à 16:33
...
CREATE TABLE `appartient` (
  `boisson_nom_boisson` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `marque_nom_marque` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `boisson` (
  ...
  `nom_boisson` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `marque` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `client` (
  ...
  `nom_client` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `age` int NOT NULL,
...
CREATE TABLE `comprend` (
  ...
  `ingredient_nom_ingredient` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `focaccia` (
  ...
  `nom_focaccia` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `prix_focaccia` float NOT NULL,
  `ingrédients` varchar(255) COLLATE utf8mb3_bin NOT NULL,
  `achete_jour` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
INSERT INTO `focaccia` (`id_focaccia`, `nom_focaccia`, `prix_focaccia`, `ingrédients`, `achete_jour`) VALUES
...
CREATE TABLE `ingredient` (
  ...
  `nom_ingredient` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `marque` (
  ...
  `nom_marque` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `menu` (
  ...
  `nom_menu` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
